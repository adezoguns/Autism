...
########################################################################################################
##########################################################################################################
def logistic_function2(X, y, test, y_test, min_acc):
    '''Logistic Function to model each leaves of the partition'''
...
def wang_tree(pathTrain, pathTest, tree_depth, num_of_class, min_acc):
    ...
    for k in mydict.keys():
        ...
        if (one >=num_of_class and zero >=num_of_class):
            ...
            if len(logistic_function2(X, y, X_test, y_test, min_acc)) != 0:
                acc, res=logistic_function2(X, y, X_test, y_test, min_acc)
                result.append(res)
                ack.append(acc*100)
    ...
    print ("\n")
    print " Ensemble accuracy2: %.2f%%\n Ensemble precision2: %.2f%% \n Ensemble recall2: %.2f%%"%(accuracy*100.0, precision*100.0, recall*100.00)
############################################################################################################
############################################################################################################
############################################################################################################
...
if __name__=="__main__":
     ...
     #print(DIVIDE_RECUR2(arr_gameTrain, 3))
